...
///// - Uses TransformGestureComponent (translation only) for direct, snappy dragging
...
//    /// and enables translation-only dragging via TransformGestureComponent.
...
//        let clampedExtents = simd.max(extents, SIMD3<Float>(repeating: 0.01))
//        let shape = ShapeResource.generateBox(size: clampedExtents * 1.1)
...
//
//        // 4) Translation-only gestures via TransformGestureComponent.
//        // Variant A (flags-based initializer):
//        container.components.set(TransformGestureComponent(translationEnabled: true, rotationEnabled: false, scaleEnabled: false))
//
//        // If Variant A doesn't compile on your SDK, use one of these instead:
//        // Variant B (options set):
//        // container.components.set(TransformGestureComponent(allows: [.translation]))
//        //
//        // Variant C (default init + flags):
//        // var tg = TransformGestureComponent()
//        // tg.translationEnabled = true
//        // tg.rotationEnabled = false
//        // tg.scaleEnabled = false
//        // container.components.set(tg)
//
//        return container
//    }
//}
